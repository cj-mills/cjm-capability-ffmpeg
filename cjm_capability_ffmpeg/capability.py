...
Docs: https://cj-mills.github.io/cjm-capability-ffmpegcapability.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/capability.ipynb.

# %% auto #0
__all__ = ['FFmpegCapabilityConfig', 'FFmpegProcessingCapability']

# %% ../nbs/capability.ipynb #306abe01
import json
import logging
import os
import subprocess
