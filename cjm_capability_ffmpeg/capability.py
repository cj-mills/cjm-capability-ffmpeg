...
cjm-capability-primitives. The adapter tells each artifact op WHERE to write.
The ffmpeg helpers under utils/ were lifted from the retired cjm-ffmpeg-utils
...
from cjm_substrate.utils.validation import (config_to_dict, dataclass_to_jsonschema, dict_to_config,
                                            SCHEMA_DESC, SCHEMA_ENUM, SCHEMA_TITLE)
